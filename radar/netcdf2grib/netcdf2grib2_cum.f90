program netcdf2grib2_cum

!================================================================
!
! Trasforma i file netdcf contenenti la precipitazione cumulata 
! da radar (cosi' come codificati ad ARPA-SIMC) in file GRIB2.
!
!================================================================
...
!-------------------------------
! get launcher name
call l4f_launcher(a_name,a_name_force="netcdf2grib2_cum")
! log4fortran init
ier=l4f_init()
! set a_name
...
if (iargc() < 1) then
  call l4f_category_log(category,L4F_ERROR,&
   "Mancano gli argomenti. Uso: netcdf2grib2_cum filencdf")
  call raise_error() 
endif
...
fileout="radar_SRT_"//trim(data_char)//trim(ora_char)//"_"//&
 trim(to_char(int(acc_t)))//"h.grib2"
